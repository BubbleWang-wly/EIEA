...
with open(pjoin('/home/qb/wluyao/code/EA-agent/PathFusion-main/data', 'DB15K-FB15K', 'ent_ids_1'), 'r') as f:
    for line in f:
        line = line.strip()
...
with open(pjoin('/home/qb/wluyao/code/EA-agent/PathFusion-main/data', 'DB15K-FB15K', 'ent_ids_2'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id, ent_name = line.split('\t')
        ent2id[ent_name] = int(ent_id)
...
with open(pjoin('/home/qb/wluyao/code/EA-agent/PathFusion-main/data', 'DB15K-FB15K', 'ref_ent_ids'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id1, ent_id2 = line.split('\t')
        seeds.append((int(ent_id1), int(ent_id2)))

with open(pjoin('/home/qb/wluyao/code/EA-agent/CM/data/MMEA-data/seed0.5', 'FB15K-DB15K', 'sup_ent_ids'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id1, ent_id2 = line.split()
        train_pair.append((int(ent_id1), int(ent_id2)))

with open(pjoin('/home/qb/wluyao/code/EA-agent/CM/data/MMEA-data/seed0.5', 'FB15K-DB15K', 'dev_ent_ids'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id1, ent_id2 = line.split()
        dev_pair.append((int(ent_id1), int(ent_id2)))

with open(pjoin('/home/qb/wluyao/code/EA-agent/PathFusion-main/data', 'DB15K-FB15K', 'attr'), 'r') as f:

...
with open(pjoin('../data/MMEA-data/seed0.8', 'FB15K-YAGO15K', 'ent_ids_1'), 'r') as f:
    for line in f:
        line = line.strip()
...
with open(pjoin('../data/MMEA-data/seed0.8', 'FB15K-YAGO15K', 'ent_ids_2'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id, ent_name = line.split('\t')
        ent2id[ent_name] = int(ent_id)
...
with open(pjoin('../data/MMEA-data/seed0.8', 'FB15K-YAGO15K', 'ref_ent_ids'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id1, ent_id2 = line.split('\t')
        seeds.append((int(ent_id1), int(ent_id2)))

with open(pjoin('../data/MMEA-data/seed0.8', 'FB15K-YAGO15K', 'sup_ent_ids'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id1, ent_id2 = line.split('\t')
        train_pair.append((int(ent_id1), int(ent_id2)))

with open(pjoin('../data/MMEA-data/seed0.8', 'FB15K-YAGO15K', 'dev_ent_ids'), 'r') as f:
    for line in f:
        line = line.strip()
        ent_id1, ent_id2 = line.split('\t')
        dev_pair.append((int(ent_id1), int(ent_id2)))

with open(pjoin('../data/MMEA-data/seed0.8', 'FB15K-YAGO15K', 'attr'), 'r') as f:
